...
# ==========================================
# NEW: MLP subnetwork for Baseline
# ==========================================
...
# ==========================================
# NEW: Global Baseline model for comparative experiments 
# (Retains DNA Seq convolution, replaces all others with MLP)
# ==========================================
class BaselineLRMLPModel(nn.Module):
    def __init__(self):
        ...
        # All modalities except 'seq' are completely replaced by End-to-End MLPs
