...
#     def __init__(self, in_channels, feature_dim=64, is_xgb=False):
#         super().__init__()
#         self.is_xgb = is_xgb
#
#         if is_xgb:
...
#             return self.fc(x)
#         else:
#             x = self.feature_extractor(x)      # [B, 64, 1]
#             x = x.permute(0, 2, 1)             # [B, 1, 64]
...
#         self.m6a_net = SparseModalityNet(1)
#         self.DNA6mA_net = SparseModalityNet(64, is_xgb=True)
#         self.methylation_net = SparseModalityNet(64, is_xgb=True)
#         self.expression_net = SparseModalityNet(64, is_xgb=True)
#
